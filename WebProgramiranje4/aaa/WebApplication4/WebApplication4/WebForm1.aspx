        ...
        <div class="auto-style1">
            <table class="auto-style2">
                ...
                <tr>
                    ...
                    <td><asp:Button ID="btxml" runat="server" Text="Prikazi XML" Width="130px" OnClick="btxml_Click"/></td>
                </tr>
            </table>
            <asp:GridView ID="GridView1" runat="server" OnSorted="GridView1_Sorted" OnSorting="GridView1_Sorting">
            </asp:GridView>
        </div>
    </form>
</body>
